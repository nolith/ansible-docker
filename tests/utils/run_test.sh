...
docker exec -it ansible /bin/sh -c "ansible-playbook /data/tests/build_container.yml -i /data/tests/inventory --syntax-check"
docker exec -it ansible /bin/sh -c "ansible-playbook -v /data/tests/build_container.yml -i /data/tests/inventory -c local"
